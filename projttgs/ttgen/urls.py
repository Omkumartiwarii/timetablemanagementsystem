...
urlpatterns = [
    ...
    path('delete_meetingtime/<int:pk>/', views.delete_meeting_time, name='deletemeetingtime'),

    path('add_courses/', views.addCourses, name='addCourses'),
    path('courses_list/', views.course_list_view, name='editcourse'),
    path('delete_course/<int:pk>/', views.delete_course, name='deletecourse'),
    ...
    path('delete_section/<int:pk>/', views.delete_section, name='deletesection'),
