...
urlpatterns = [
    ...
    path('generate/', views.generate_view, name='generate'),
    path('assign-lab-room/',views.add_subject_lab_room,name='add_subject_lab_room'),
    ...
    path('delete-subject-lab-room/<int:id>/',views.delete_subject_lab_room,name='delete_subject_lab_room'),
