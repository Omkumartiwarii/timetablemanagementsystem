...
def seed_database():
    ...
    # DEPARTMENTS
    # =========================
    CSE = Department.objects.create(name="Computer Science Eng")
    ECE = Department.objects.create(name="Electronics Ccommunication Eng")
    ME = Department.objects.create(name="Mechanical Eng")
    CE = Department.objects.create(name="CIVIL")
    CECA = Department.objects.create(name="Civil Engineering Computer Applied")
    EE = Department.objects.create(name="Electrical Eng")
    APS = Department.objects.create(name="Applied Science")
